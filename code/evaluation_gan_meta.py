...
def evaluation():
    ...
    saver = tf.train.import_meta_graph(
        '/media/server009/seagate/liuhan/lls/github/yousaidthat-tf/code14-server009/models/train_12191-155616_idnum1/train_12191-155616_idnum1.ckpt-18286.meta')
    ...
    with sv.managed_session() as sess:
        ...
        if ckpt:
            ...
            ckpt_step = ckpt_file.readlines()[0].split("\"")[1].split('-')[-1]
    ...
    if args.mp4 == 1:
        save_video(OUTPUT_DIR, WAV_TO_GENERATE_MP4_PATH,
                   '{}-{}.mp4'.format(OUTPUT_DIR, ckpt_step))
