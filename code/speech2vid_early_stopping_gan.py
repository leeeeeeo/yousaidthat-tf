...
def speech2vid_early_stopping_gan(testNpzList, CHECKPOINT_DIR, earlyStoppingLossList, USE_AUDIO, USE_BN, USE_LIP, USE_DECODER, USE_FACEFC, USE_AUDIOFC, USE_FACE, USE_XAVIER, AVOID_LAYERS_LIST, ID_NUM, GAN_WEIGHT, L1_WEIGHT, IS_TRAINING):
    testLossList = []
    testGraph = tf.Graph()
