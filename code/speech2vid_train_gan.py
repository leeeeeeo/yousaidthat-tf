...
import math
from speech2vid_early_stopping_gan import speech2vid_early_stopping_gan
        ...
        try:
            ...
            for step in range(STEP_START, TRAINING_STEPS):
                ...
                if should(args.early_stopping_freq):
                    earlyStoppingLoss = speech2vid_early_stopping_gan(testNpzList, MODEL_SAVE_PATH, earlyStoppingLossList, USE_AUDIO, USE_BN,
